        ...
        <div className="page-container">
          ...
          <section className="mb-10 sm:mb-16 space-y-4">
            ...
            <div className="space-y-4">
              <CopyEmail />
              <div className="flex items-center gap-3.5 text-warm-white/70">
                <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="flex-shrink-0">
              ...
              <a
                ...
                className="flex items-center gap-3.5 text-warm-white/85 hover:text-accent transition-colors group"
              >
                <svg viewBox="0 0 24 24" fill="currentColor" width="17" height="17" className="flex-shrink-0 group-hover:text-accent transition-colors">
